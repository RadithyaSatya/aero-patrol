        ...
        >
            ...
            >
                ...
                <div className="px-6 py-6 sm:px-7 sm:py-7">
                    <div className="mb-5">
                        <h2 className="text-[20px] font-medium uppercase tracking-[0.18em] text-white">Delete Mission</h2>
                    </div>

                    <p className="text-[13px] leading-6 text-[#F2D6D6]">
                        Delete mission
                        <span className="mx-1 text-white">{missionName || 'this mission'}</span>
                        permanently from the list? This action cannot be undone.
                    </p>

                    {errorMsg ? (
                        <div
                            className="mt-5 border px-4 py-3 text-[12px] text-[#FFD0D0]"
